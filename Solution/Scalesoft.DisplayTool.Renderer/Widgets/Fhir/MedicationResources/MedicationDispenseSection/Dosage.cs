                            ...
                            new If(_ => infrequentOptions.Contains(InfrequentPropertiesPaths.AsNeeded),
                                ...
                                [
                                    new TextContainer(TextStyle.Bold,
                                        [
                                            new Condition("f:asNeededCodeableConcept",
                                                [
                                                    new ConstantText("Brát dle potřeby - "),
                                                    new ChangeContext("f:asNeededCodeableConcept",
                                                        new CodeableConcept()),
                                                ]
                                            ),
                                            new Condition("f:asNeededBoolean",
                                                children:
                                                [
                                                    new ShowBoolean(
                                                        onFalse: new ConstantText("Brát dle instrukcí"),
                                                        onTrue: new ConstantText("Brát dle potřeby"),
                                                        path: "f:asNeededBoolean"
                                                    ),
                                                ]
                                            ),
                                        ]
