...
public class DastaPatientInfoWidget : Widget
{
            ...
            [
                new Section($"/ds:dasta/ds:is/dsip:ip[{i + 1}]", null,
                    ...
                    [
                        new Row([
                            new Choose([
                                new When("dsip:titul_pred", [
                                    new Container([
                                        new Badge(new ConstantText("Titul před jménem"), Severity.Primary),
                            ...
                            new Choose([
                                new When("dsip:jmeno", [
                                    new Container([
                                        new Badge(new ConstantText("Jméno"), Severity.Primary),
                                        new Heading([new Text("dsip:jmeno")], HeadingSize.H3),
                                    ]),
                                ])
                            ]),
                            new Container([
                                new Badge(new ConstantText("Příjmení"), Severity.Primary),
                                new Heading([new Text("dsip:prijmeni")], HeadingSize.H3),
                            ]),
                            new Choose([
                                new When("dsip:titul_za", [
                                    new Container([
                                        new Badge(new ConstantText("Titul za jménem"), Severity.Primary),
                                        new Heading([new Text("dsip:titul_za")], HeadingSize.H3),
                                    ]),
                                ])
                            ]),
                            new Choose([
                                new When("dsip:dat_dn", [
                                    new Container([
                                        new Badge(new ConstantText("Datum a čas narození"), Severity.Primary),
                                        new Heading([new DastaDate("dsip:dat_dn"),], HeadingSize.H3),
                                    ]),
                                ])
                            ]),
                            new Container([
                                new Badge(new ConstantText("Identifikátor pacienta"), Severity.Primary),
                                new Heading([
                                    new Text("@id_pac"),
                                    new Choose([
                                        new When("not(@typ_id_pac) or @typ_id_pac = '0'", [
                                            new TextContainer(TextStyle.Muted, [new ConstantText(" (číslo pojištěnce)"),])
                                        ])
                                    ]),
                                ], HeadingSize.H3),
                            ]),
                        ...
                        new Row([
                            new Choose([
                                new When("dsip:rodcis", [
                                    new Container([
                                        new Badge(new ConstantText("Rodné číslo"), Severity.Primary),
                            ...
                            new Choose([
                                new When("dsip:rip", [
                                    new Container([
                                        new Badge(new ConstantText("Resortní identifikátor pacienta"), Severity.Primary),
                                        new Heading([new Text("dsip:rip"),], HeadingSize.H6),
                                    ]),
                                ])
                            ]),
                            new Choose([
                                new When("dsip:id_card", [
                                    new Container([
                                        new Badge(new ConstantText("Číslo občanského průkazu"), Severity.Primary),
                                        new Heading([new Text("dsip:id_card/dsip:id_number"),], HeadingSize.H6),
                                        new Choose([
                                            new When("dsip:id_card/dsip:dat_pl", [
                                                new Badge(new ConstantText("Konec platnosti občanského průkazu"), Severity.Primary),
                            ...
                            new Choose([
                                new When("dsip:passport", [
                                    new Container([
                                        new Badge(new ConstantText("Číslo cestovního pasu"), Severity.Primary),
                                        new Heading([new Text("dsip:passport/dsip:id_number"),], HeadingSize.H6),
                                        new Choose([
                                            new When("dsip:passport/dsip:stat", [
                                                new Badge(new ConstantText("Stát, který cestovní pas vydal"), Severity.Primary),
                                                new Heading([
                                        ...
                                        new Choose([
                                            new When("dsip:passport/dsip:dat_pl", [
                                                new Badge(new ConstantText("Konec platnosti cestovního pasu"), Severity.Primary),
                            ...
                            new Choose([
                                new When("dsip:misto_nar", [
                                    new Container([
                                        new Badge(new ConstantText("Místo narození"), Severity.Primary),
                                        new Heading([new Text("dsip:misto_nar"),], HeadingSize.H6),
                                    ]),
                                ])
                            ]),
                            new Choose([
                                new When("dsip:stat_pris", [
                                    new Container([
                                        new Badge(new ConstantText("Státní příslušnost"),
                                            Severity.Primary),
                                        new Heading([
                            ...
                            new Choose([
                                new When("dsip:dat_de", [
                                    new Container([
                                        new Badge(new ConstantText("Datum a čas úmrtí"), Severity.Primary),
                            ...
                            new Choose([
                                new When("dsip:sex", [
                                    new Container([
                                        new Badge(new ConstantText("Pohlaví úřední"), Severity.Primary),
                                        new Heading(
                                        [
                            ...
                            new Choose([
                                new When("dsip:sex_klin", [
                                    new Container([
                                        new Badge(new ConstantText("Pohlaví pro klinické použití"), Severity.Primary),
                                        new Heading([
                            ...
                            new Choose([
                                new When("dsip:rod_prijm", [
                                    new Container([
                                        new Badge(new ConstantText("Rodné příjmení"), Severity.Primary),
                                        new Heading([new Text("dsip:rod_prijm"),], HeadingSize.H6),
                                    ]),
                                ])
                            ]),
                            new Choose([
                                new When("dsip:jine_idu", [
                                    new Container([
                                        new Badge(new ConstantText("Jiné identifikační údaje"), Severity.Primary),
                            ...
                            // ignore duvernost
                            new Container([
                                new Badge(new ConstantText("Komunikační jazyk"), Severity.Primary),
                                new Choose([
                                    new When("dsip:jazyk", [
                                        new ItemListBuilder("dsip:jazyk", ItemListType.Unordered, i =>
                                        [
                                            new Heading([
                                    ...
                                    new Heading([
                                        new DastaCodedValue(context.Language.Primary.Code, "1.3.6.1.4.1.12559.11.10.1.3.1.42.6",
                            ...
                            // ignore ipi_v
                            new Choose([
                                new When("dsip:povolani", [
                                    new Container([
                                        new Badge(new ConstantText("Povolání pacienta"), Severity.Primary),
        ...
        return new ConcatBuilder("ds:as", i =>
            [
                new Container([
                    ...
                    new LineBreak(),
                    new Choose([
                        new When("ds:sdeleni or ds:heslo", [
                            new Tooltip(
                                ...
                                [
                                    new Choose([
                                        new When("ds:sdeleni",
                                        [
                                            new NameValuePair([new ConstantText("Textová informace k adrese")], [new Text("ds:sdeleni")]),
                                        ])
                                    ]),
                                    new Choose([
                                        new When("ds:heslo",
                                            [new NameValuePair([new ConstantText("Heslo pro sdělení informací")], [new Text("ds:heslo")]),])
                                    ]),
                                ],
                                []
                            ),
    ...
    private Widget DisplayAddressAndTelecom()
    {
        ...
        return new Container([
            new Badge(new TextContainer(TextStyle.Regular, [
    ...
    private Widget DisplayAddress()
    {
        return new Container([
            ...
            // ignore stat
            new Choose([
                new When("ds:stat_text", [
                    new ConstantText(" "),
                    new Text("ds:stat_text"),
                ])
            ]),
            // ignore gps
            new LineBreak(),
    ...
    private IList<Widget> DisplayRelatedPersonsAndCompanies()
    {
        ...
        [
            ...
            new Container([
                new Badge(new ConstantText("Jméno / název"), Severity.Primary),
                new Heading([new Text("ds:jmeno"),], HeadingSize.H6),
            ]),
            new Choose([
                new When("@typ = '3' and ds:vztah", [
                    new Container([
                        new Badge(new ConstantText("Příbuzenský vztah k pacientovi"), Severity.Primary),
            ...
            new Choose([
                new When("@typ = 'K'", [
                    new Choose([
                        new When("ds:k_osoba_klic", [
                            new Container([
                                new Badge(new ConstantText("Osobní vztah"), Severity.Primary),
                                new Heading([
                    ...
                    new Choose([
                        new When("ds:k_osoba_pozn", [
                            new Container([
                                new Badge(new ConstantText("Poznámka"), Severity.Primary),
                                new Heading([new Text("ds:k_osoba_pozn"),], HeadingSize.H6),
                            ]),
                        ])
                    ]),
                    new Choose([
                        new When("ds:k_osoba_typ", [
                            new Container([
                                new Badge(new ConstantText("Typ kontaktu"), Severity.Primary),
                                new Heading([
                    ...
                    new Choose([
                        new When("ds:k_osoba_pravo", [
                            new Container([
                                new Badge(new ConstantText("Právo"), Severity.Primary),
                                new LineBreak(),
                                new Choose([
                                    new When("ds:k_osoba_pravo = 'N'",
                                    [
                                        new DastaMockCodedValue("'N'",
                                            "https://www.dastacr.cz/dasta/hypertext/DSAAK.htm#k_osoba_pravo_sezn"),
                                    ]),
                                    new When("ds:k_osoba_pravo = 'A'",
                                    [
                                        new DastaMockCodedValue("'A'",
                                            "https://www.dastacr.cz/dasta/hypertext/DSAAK.htm#k_osoba_pravo_sezn"),
                                    ]),
                                    new When("ds:k_osoba_pravo = 'D'",
                                    [
            ...
            new Choose([
                new When("@typ = '4' or @typ = 'G' or @typ = 'M' or @typ = 'C'", [
                    new Choose([
                        new When("ds:icl", [
                            new Container([
                                new Badge(new ConstantText("Identifikační číslo praktického lékaře pacienta"), Severity.Primary),
                    ...
                    new Choose([
                        new When("ds:id_zp", [
                            new Container([
                                new Badge(new ConstantText("Identifikace ZP"), Severity.Primary),
    ...
    private IList<Widget> DisplayDataValidity(EntityType entityType)
    {
        ...
        Widget[] validFromLabelWidget = entityType == EntityType.Other
            ? [new Badge(validFromLabel, Severity.Primary)]
        ...
        Widget[] validToLabelWidget = entityType == EntityType.Other
            ? [new Badge(validToLabel, Severity.Primary)]
    ...
    private IList<Widget> DisplayDataNote(EntityType entityType)
    {
        ...
        Widget[] noteLabelWidget = entityType == EntityType.Other
            ?
            [
                new Badge(noteLabel, Severity.Primary),
            ]
            :
            [
