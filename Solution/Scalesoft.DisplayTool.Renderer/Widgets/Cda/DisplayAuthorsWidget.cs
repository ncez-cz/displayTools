                ...
                new Collapser([
                    ...
                    [], [
                        new Choose([
                            new When("$assignedPerson", [
                                new Choose([
                                    new When("not($assignedPerson/n1:name/@nullFlavor)", [
                                    ...
                                    new Text("$assignedEntity/n1:representedOrganization/n1:name"),
                                ...
                                new Condition("$functionCode and not($functionCode/@nullFlavor)", [
                                    new Container([
                                        new Badge(new ConstantText("Skupina"), Severity.Primary),
                                        new LineBreak(),
                            ...
                            new Text("$AuthoringDeviceName/n1:manufacturerModelName"),
                            new ConstantText(@" 
                                        "),
                            new ConstantText(@"
                                        ("),
                            new Text("$AuthoringDeviceName/n1:softwareName"),
                            new ConstantText(@")
                                    "),
                        ]),
