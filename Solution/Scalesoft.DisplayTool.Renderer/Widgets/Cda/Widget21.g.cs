...
new Variable("probEndDate", "../../../n1:effectiveTime/n1:high"), 
new Variable("problemStatusCode", "../n1:entryRelationship[@typeCode='REFR']/n1:observation/n1:templateId[@root='1.3.6.1.4.1.12559.11.10.1.3.1.3.9']/../n1:value"), 
...
TableCellType.Data, 7), 
]), 
]),
], [
new TableRow([
new TableCell([
new WidgetWithVariables(new ShowEHdsiRareDiseasesWidget(), [
...
new TableCell([
new WidgetWithVariables(new ShowTsWidget(), [
new Variable("node", "$probEndDate"),
]), 
],
TableCellType.Data), 
new TableCell([
new WidgetWithVariables(new ShowEHdsiStatusCodeWidget(), [
new Variable("node", "$problemStatusCode"),
]), 
],
TableCellType.Data), 
new TableCell([
